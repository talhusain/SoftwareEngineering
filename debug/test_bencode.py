import unittest
<<<<<<< HEAD:debug/test_bencode.py
import bencode
=======
from bencode import encode, decode
>>>>>>> 7f53710bed8128ecbb99c37ebd94066da5b8aac9:debug/bencoding/test_bencode.py
...
class TestEncode(unittest.TestCase):
    ...
    def test_dict(self):
        ...
        self.n = encode({b"bar": b"spam", b"foo": 42})
...
class TestDecode(unittest.TestCase):
    ...
    def test_dict(self):
        ...
        self.n = decode(b"d3:bar4:spam3:fooi42ee")
...
#
#         with self.assertRaises(ValueError):
#             _tokenize(b"asdfasdfifniubcbiufdcnlsakjcabfuqiwegfqwhbcalsdcalsdkf")
